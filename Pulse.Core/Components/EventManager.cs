...
namespace Pulse.Core.Components
{
    ...
    public class EventManager
    {
        ...
        //Limit queue processing allows us to put a max time on queues trigger per frame
        ...
        //Full list of listeners, waiting to be actioned by event queue. This stores te delegates as actioned calls
